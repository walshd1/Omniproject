...
export const SAMPLE_ISSUES: Record<string, Row[]> = {
  "proj-001": [
    { id: "iss-001", projectId: "proj-001", title: "Migrate auth service to OIDC", description: "Replace legacy JWT flow with OIDC + Authentik", status: "in_progress", priority: "urgent", assignee: "alice", labels: ["auth", "infra"], startDate: "2026-06-10", dueDate: "2026-06-28", currency: "GBP", budget: 45000, actualCost: 28000, billable: true, costCenter: "ENG-PLAT", estimateHours: 40, loggedHours: 26, remainingHours: 18, storyPoints: 8, source: "jira", createdAt: new Date(Date.now() - 1000 * 60 * 60 * 72).toISOString(), updatedAt: new Date(Date.now() - 1000 * 60 * 20).toISOString() },
    { id: "iss-002", projectId: "proj-001", title: "Set up bidirectional broker flow", description: "Configure the broker to handle inbound and outbound payloads", status: "todo", priority: "high", assignee: "bob", labels: ["integration"], startDate: "2026-06-20", dueDate: "2026-07-05", currency: "GBP", budget: 30000, actualCost: 6000, billable: true, costCenter: "ENG-PLAT", estimateHours: 24, loggedHours: 4, remainingHours: 20, storyPoints: 5, source: "jira", createdAt: new Date(Date.now() - 1000 * 60 * 60 * 48).toISOString(), updatedAt: new Date(Date.now() - 1000 * 60 * 60 * 2).toISOString() },
