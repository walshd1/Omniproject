# Feature Roadmap — Delivered (archive)

Items shipped (✅ **Done**), split out of [FEATURE-ROADMAP](../FEATURE-ROADMAP.md) so the roadmap tracks only remaining work. Grouped under their original phase headings.
