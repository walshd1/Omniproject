...
- **[FEATURE-ROADMAP.md](FEATURE-ROADMAP.md)** — the feature-level roadmap: every state-of-the-art parity gap disposed as candidate / tracked / decided-against, with the build sequencing.
