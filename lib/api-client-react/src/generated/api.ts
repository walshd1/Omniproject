...
export const brokerCommand = async (brokerCommandInput: BrokerCommandInput, options?: RequestInit): Promise<BrokerCommandResult> => {
  ...
  return customFetch<BrokerCommandResult>(getBrokerCommandUrl(),
  {
    ...
    body: JSON.stringify(brokerCommandInput)
  }
);}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetProjectIssuesQueryKey(projectId);
   ...
   return  { queryKey, queryFn, enabled: projectId !== null && projectId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getProjectIssues>>, TError, TData> & { queryKey: QueryKey }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListTaskItemsQueryKey(projectId,issueId);
   ...
   return  { queryKey, queryFn, enabled: projectId !== null && projectId !== undefined && issueId !== null && issueId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listTaskItems>>, TError, TData> & { queryKey: QueryKey }
}
...
export const createTaskItem = async (projectId: string,
  ...
  return customFetch<TaskItem>(getCreateTaskItemUrl(projectId,issueId),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(taskItemInput)
  }
);}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetProjectCapacityQueryKey(projectId);
   ...
   return  { queryKey, queryFn, enabled: projectId !== null && projectId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getProjectCapacity>>, TError, TData> & { queryKey: QueryKey }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetProjectFinancialsQueryKey(projectId);
   ...
   return  { queryKey, queryFn, enabled: projectId !== null && projectId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getProjectFinancials>>, TError, TData> & { queryKey: QueryKey }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetProjectHistoryQueryKey(projectId);
   ...
   return  { queryKey, queryFn, enabled: projectId !== null && projectId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getProjectHistory>>, TError, TData> & { queryKey: QueryKey }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetProjectBaselineQueryKey(projectId);
   ...
   return  { queryKey, queryFn, enabled: projectId !== null && projectId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getProjectBaseline>>, TError, TData> & { queryKey: QueryKey }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetProjectRaidQueryKey(projectId);
   ...
   return  { queryKey, queryFn, enabled: projectId !== null && projectId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getProjectRaid>>, TError, TData> & { queryKey: QueryKey }
}
...
export const createRaidEntry = async (projectId: string,
  ...
  return customFetch<RaidEntry>(getCreateRaidEntryUrl(projectId),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(raidEntryInput)
  }
);}
