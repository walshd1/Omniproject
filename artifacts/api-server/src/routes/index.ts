...
import ragVocabularyRouter from "./rag-vocabulary";
...
import delegationPolicyRouter from "./delegation-policy";
...
router.use(requireAuth, deploymentTypesRouter);
...
router.use(requireAuth, releaseRouter);
