...
const CLASSIFICATION: Record<string, ScopeClass> = {
  ...
  "GET /projects/:projectId/dependencies": "project-scope",
  "POST /projects/:projectId/dependencies": "project-scope",
  "DELETE /projects/:projectId/dependencies": "project-scope",
  "GET /projects/:projectId/sprints": "project-scope",
  "POST /projects/:projectId/sprints": "project-scope",
  "DELETE /projects/:projectId/sprints/:sprintId": "project-scope",
