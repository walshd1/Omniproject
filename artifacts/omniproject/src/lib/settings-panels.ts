...
export const SETTINGS_PANEL_KEYS = [
  ...
  "governanceDashboard", "governance", "users", "passkeySecurity", "recoveryKey", "roleMap", "customRoles", "defPolicy", "aiProviders", "aiAllowlists", "actionCatalogue", "a11y", "notifications", "twoFactor", "deviceSessions", "calendarPush", "labels",
