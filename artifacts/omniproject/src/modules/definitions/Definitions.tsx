...
const KIND_LABEL: Record<DefKind, string> = {
  primitive: "Primitive", screen: "Screen", form: "Form", report: "Report", dashboard: "Dashboard", gridColumns: "Grid columns",
  businessRule: "Business rule", methodology: "Methodology", mapping: "Field mapping", customField: "Custom field", theme: "Theme (colours)", font: "Font", jsonDef: "JSON def",
};
