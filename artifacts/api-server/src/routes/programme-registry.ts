 ...
 * authenticated session (the programme UI renders from it); authoring is gated to either governance
 * authority — PMO (business) or admin (technical). Sealed at rest with the rest of settings.
 */
