...
const WRITE_ACTIONS: ReadonlySet<ContractAction> = new Set(["create_issue", "update_issue", "delete_issue", "create_invoice", "update_invoice", "create_client", "update_client", "create_product", "update_product", "create_payment", "create_credit_note", "create_quote", "update_quote", "create_tax_rate", "update_tax_rate", "create_vendor", "update_vendor", "create_expense", "update_expense", "create_bill", "create_purchase_order", "update_purchase_order", "create_account", "create_journal_entry"]);
