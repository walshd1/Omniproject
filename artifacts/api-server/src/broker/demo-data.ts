...
export const SAMPLE_PROJECTS: Row[] = [
  ...
  { id: "proj-002", name: "API Gateway v2", identifier: "AGW", description: "New unified API gateway", source: "plane", programmeId: "prog-platform", programmeName: "Platform Modernization", issueCount: 18, completedCount: 14, memberCount: 3, updatedAt: new Date(Date.now() - 1000 * 60 * 90).toISOString() },
...
export const SAMPLE_ISSUES: Record<string, Row[]> = {
  "proj-001": [
    ...
    { id: "iss-002", projectId: "proj-001", title: "Set up bidirectional broker flow", description: "Configure the broker to handle inbound and outbound payloads", status: "todo", priority: "high", assignee: "bob", labels: ["integration"], startDate: "2026-06-20", dueDate: "2026-07-05", source: "plane", createdAt: new Date(Date.now() - 1000 * 60 * 60 * 48).toISOString(), updatedAt: new Date(Date.now() - 1000 * 60 * 60 * 2).toISOString() },
  ...
  "proj-003": [
    ...
    { id: "iss-011", projectId: "proj-003", title: "OIDC token relay in API proxy", description: "Extract Bearer from session, attach to brokered requests", status: "in_progress", priority: "high", assignee: "bob", labels: ["auth", "backend"], startDate: "2026-06-10", dueDate: "2026-06-30", source: "openproject", createdAt: new Date(Date.now() - 1000 * 60 * 60 * 24 * 12).toISOString(), updatedAt: new Date(Date.now() - 1000 * 60 * 60 * 3).toISOString() },
  ],
  "proj-004": [
