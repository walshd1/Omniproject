 ...
 *
 * Vendor-neutral by construction — plain task records in, plain result out — so it lives below the
 * broker seam and is shared by every surface (SPA report, API, analytics) instead of being
