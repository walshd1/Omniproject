...
const KNOWN_ENV_VARS = [
  ...
  "AI_PROVIDER", "AI_TOKEN_BUDGET", "API_TOKENS",
  "ATTACHMENTS_ALLOWED_ORIGIN", "ATTACHMENTS_CLAMAV_ADDRESS", "ATTACHMENTS_CLAMAV_TIMEOUT_MS",
  "ATTACHMENTS_MAX_BYTES", "ATTACHMENTS_MAX_PER_ROOM", "ATTACHMENTS_SCAN_ALLOW_EXECUTABLES", "ATTACHMENTS_SCAN_FAIL_OPEN",
  "ATTACHMENTS_SIDECAR_PUBLIC_URL", "ATTACHMENTS_SIDECAR_TOKEN", "ATTACHMENTS_SIDECAR_URL", "ATTACHMENTS_TICKET_SECRET",
  "AUDIT_BATCH", "AUDIT_FLUSH_MS", "AUDIT_HTTP_TOKEN",
  ...
  "FEDERATION_SELF_LABEL", "FX_RATE_AS_OF_DATE", "FX_RATE_POLICY", "HEALTH_WATCH_INTERVAL_HOURS",
  ...
  "READ_CACHE_TTL_MS", "REDIS_URL", "REPLICA_ID", "REPORTING_CURRENCY",
  "RETENTION_BROKER_TOKEN", "RETENTION_BROKER_URL", "SAML_ACR_ATTR",
  ...
  "SAML_WANT_RESPONSE_SIGNED", "SCHEDULER_HEARTBEAT_MINUTES", "SCIM_TOKEN", "SECURITY_CONTACT_URL", "SECURITY_POLICY_URL",
  ...
  "SMTP_URL", "SOD_POLICIES", "STEP_UP_MINUTES", "STT_PROVIDER", "TOTP_FILE", "TOTP_SECRET", "TRUST_PROXY",
