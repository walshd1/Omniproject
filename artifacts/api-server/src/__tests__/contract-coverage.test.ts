...
const COVERED: Record<string, string> = {
  ...
  "/programmes": "verify-broker",
  "/programmes/{programmeId}": "verify-broker",
  "/projects/{projectId}/issues": "security.test.ts, e2e-smoke, broker-conformance",
  "/projects/{projectId}/issues/{issueId}": "verify-broker (concurrency), broker-conformance",
  ...
  "/tasks": "tasks-routes.test.ts (GET /tasks lists demo tasks; ?projectId scoping)",
  ...
  "/projects/{projectId}/history": "verify-broker, broker-conformance",
  "/projects/{projectId}/baseline": "verify-broker, broker-conformance",
  ...
  "/settings": "security.test.ts, verify-broker",
