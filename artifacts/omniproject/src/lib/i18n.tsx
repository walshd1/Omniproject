...
const EN: Dict = {
  ...
  "header.demoBanner": "Demo mode — showing sample data. Connect your n8n + backend to go live.",
  "header.openSetup": "Open setup →",
...
const FR: Dict = {
  ...
  "header.demoBanner": "Mode démo — données d'exemple. Connectez votre n8n + backend pour passer en production.",
  "header.openSetup": "Ouvrir la configuration →",
...
const DE: Dict = {
  ...
  "header.demoBanner": "Demomodus — Beispieldaten. Verbinden Sie n8n + Backend für den Live-Betrieb.",
  "header.openSetup": "Einrichtung öffnen →",
...
const ES: Dict = {
  ...
  "header.demoBanner": "Modo demo — datos de ejemplo. Conecta tu n8n + backend para producción.",
  "header.openSetup": "Abrir configuración →",
