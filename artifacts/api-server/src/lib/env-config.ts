...
const KNOWN_ENV_VARS = [
  ...
  "BRAND_SUPPORT_URL", "BROKER_CAPTURE", "BROKER_LOG_SIZE", "BROKER_PSK", "BROKER_TRACE", "BROKER_URL",
  ...
  "EGRESS_ALLOWLIST", "ENABLED_FEATURES", "EXEC_DIGEST_INTERVAL_HOURS", "FEDERATED_PEERS",
  ...
  "SESSION_SECRET", "SIGNING_PRIVATE_KEY", "STEP_UP_MINUTES", "STT_PROVIDER", "TRUST_PROXY",
