...
export const SAMPLE_PROJECTS: Row[] = [
  ...
  { id: "proj-002", name: "API Gateway v2", identifier: "AGW", description: "New unified API gateway", source: "openproject", programmeId: "prog-platform", programmeName: "Platform Modernization", issueCount: 18, completedCount: 14, memberCount: 3, updatedAt: new Date(Date.now() - 1000 * 60 * 90).toISOString() },
  { id: "proj-003", name: "Enterprise SSO", identifier: "SSO", description: "OIDC-based single sign-on across all services", source: "github", programmeId: "prog-security", programmeName: "Security & Identity", issueCount: 11, completedCount: 7, memberCount: 2, updatedAt: new Date(Date.now() - 1000 * 60 * 60 * 4).toISOString() },
  { id: "proj-004", name: "Monitoring Stack", identifier: "MON", description: "Observability infrastructure: metrics, traces, logs", source: "azure-devops", programmeId: null, programmeName: null, issueCount: 8, completedCount: 2, memberCount: 4, updatedAt: new Date(Date.now() - 1000 * 60 * 60 * 24).toISOString() },
];

export const SAMPLE_ISSUES: Record<string, Row[]> = {
  "proj-001": [
    { id: "iss-001", projectId: "proj-001", title: "Migrate auth service to OIDC", description: "Replace legacy JWT flow with OIDC + Authentik", status: "in_progress", priority: "urgent", assignee: "alice", labels: ["auth", "infra"], startDate: "2026-06-10", dueDate: "2026-06-28", source: "jira", createdAt: new Date(Date.now() - 1000 * 60 * 60 * 72).toISOString(), updatedAt: new Date(Date.now() - 1000 * 60 * 20).toISOString() },
    { id: "iss-002", projectId: "proj-001", title: "Set up bidirectional broker flow", description: "Configure the broker to handle inbound and outbound payloads", status: "todo", priority: "high", assignee: "bob", labels: ["integration"], startDate: "2026-06-20", dueDate: "2026-07-05", source: "jira", createdAt: new Date(Date.now() - 1000 * 60 * 60 * 48).toISOString(), updatedAt: new Date(Date.now() - 1000 * 60 * 60 * 2).toISOString() },
