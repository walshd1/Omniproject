...
const WRITE_ACTIONS: ReadonlySet<ContractAction> = new Set(["create_issue", "update_issue", "delete_issue", "create_invoice", "update_invoice", "create_client", "update_client", "create_product", "update_product", "create_payment", "create_credit_note", "create_quote", "update_quote", "create_tax_rate", "update_tax_rate", "create_vendor", "update_vendor", "create_expense", "update_expense", "create_bill", "create_purchase_order", "update_purchase_order", "create_account", "create_journal_entry", "create_bank_account", "create_bank_transaction", "create_fx_rate", "create_fiscal_period", "update_fiscal_period", "create_dimension", "update_dimension", "create_rev_rec_schedule", "update_rev_rec_schedule", "create_goods_receipt", "update_goods_receipt", "create_fixed_asset", "update_fixed_asset", "create_dependency", "update_dependency", "delete_dependency", "create_baseline", "update_baseline", "create_resource", "update_resource", "create_assignment", "update_assignment", "create_timesheet", "update_timesheet", "create_benefit", "update_benefit", "create_milestone", "update_milestone", "create_change_request", "update_change_request", "create_stage_gate", "update_stage_gate", "create_skill", "update_skill", "create_resource_skill", "update_resource_skill", "create_leave", "update_leave", "create_portfolio", "update_portfolio", "create_booking", "update_booking"]);
