 ...
 */
const ENTERPRISE_BACKENDS = new Set(["sap", "sap-s4hana-financials", "primavera", "dynamics365", "dynamics365-sales", "dynamics365-fo", "msproject", "netsuite", "enterprise", "planview"]);
