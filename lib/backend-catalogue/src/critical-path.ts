 ...
 *
 * Vendor-neutral by construction — it takes plain node/edge records and returns plain
 * results, so it lives below the broker seam and is shared by every surface (SPA, API,
 * report engine) instead of being re-implemented per consumer.
 */
