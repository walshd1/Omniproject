 ...
 * whose primary record is the priced line item). Extend as new record domains land.
 *
 ...
 */
export const BACKEND_RECORD_TYPES = ["issue", "invoice", "client", "product"] as const;
