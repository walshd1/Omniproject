...
//
// Usage:
//   AUDIT_KEY=... node tools/verify-audit-chain.mjs audit.ndjson [expectedFirstPrevHash]
//
...
const [file, expectedFirstPrev = GENESIS] = process.argv.slice(2);
if (!file) { console.error("usage: verify-audit-chain.mjs <audit.ndjson> [expectedFirstPrevHash]"); process.exit(2); }
